...
import Blackbaud from "../../assets/blackbaud-vector-logo.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>How may AI help you?</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured discuss Blackbaud and their Environment, Social, and Governance efforts</h2>
                            </Stack>
                        ) : (
